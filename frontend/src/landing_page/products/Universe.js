        ...
        <div className='container mb-5 py-4 text-center'>
            <div className='row text-muted'>
                ...
                <div className='col-4 p-4 '>
                    <img src="media/zerodhaFundhouse.png" alt='' style={{width:"80%",paddingLeft:"6rem",marginBottom:"2rem"}} />
                ...
                <div className='col-4 p-4'>
                    <img src="media/sensibullLogo.svg" alt='' style={{width:"80%",paddingLeft:"6rem",marginBottom:"2rem"}} />
                ...
                <div className='col-4 p-4'>
                    <img src="media/tijori.svg" alt='' style={{width:"80%",paddingLeft:"6rem",marginBottom:"2rem"}} />
                ...
                <div className='col-4 p-4 '>
                    <img src="media/streakLogo.png" alt='' style={{width:"80%",paddingLeft:"6rem",marginBottom:"2rem"}} />
                    <p className='ps-5 mb-4'>Systematic trading platform that allows you to create and backtest strategies without coding.</p>
                </div>
                <div className='col-4 p-4'>
                    <img src="media/smallcaseLogo.png" alt='' style={{width:"80%",paddingLeft:"6rem",marginBottom:"2rem"}} />
                    <p className='ps-5 mb-4'>Thematic investing platform that helps you invest in diversified baskets of stocks on ETFs.</p>
                </div>
                <div className='col-4 p-4'>
                    <img src="media/dittoLogo.png" alt='' style={{width:"70%",paddingLeft:"6rem",marginBottom:"2rem"}} />
