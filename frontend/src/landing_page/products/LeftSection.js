        ...
        <div className='container my-5 py-5'>
            <div className='row'>
                <div className='col-lg-7 p-3'>
                    <img alt='' src={imageUrl} style={{width:"85%"}} />
                </div>
                <div className='col-lg-5 my-5'>
                    ...
                    <div> 
                        <a href={googlePlay}><img alt='' className='me-3 ' src="media/googlePlayBadge.svg" /></a>
                        <a href={appStore}><img alt='' src="media/appstoreBadge.svg" /></a>
                    </div>
                </div>
            </div>
        </div>
