...
function Hero() {
    return ( 
        <div className='container my-5'>
            <h1 className='text-center hero-info'>We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h1>
            <hr/>
            <div className='row hero-desc'>
